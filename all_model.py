# -*- coding: utf-8 -*-
"""
Created on Sep  2 05:57:53 2021
...
def BASIC_UNET(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True):
    '''
    UNet, 
    ...
    # Model 
    model = models.Model(inputs, conv_final, name="BASIC_UNET")
    print(model.summary())
    return model
